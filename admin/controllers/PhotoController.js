...
module.exports.AjouterPhotoAccueil = function(request, response){
    response.title = "Vips";
     ...
     async.series([
         function(callback){
           ...
           function(callback){
            ...
            function(callback){
              model.photoNumero(vipNum, function(err3, result3) {callback(null, result3)});
            }
     ],
     function(err, result){
          if (err){
...
module.exports.SupprimerPhotoAccueil = function(request, response){
    response.title = "Vips";
    model.vips(function(err, result){
        if (err) {
            console.log(err);
    ...
    let vipNum = request.body.vip;
     ...
     async.series([
         function(callback){
           ...
           function(callback){
            model.photosVip(vipNum, function(err2, result2) {callback(null, result2)});
            },
     ],
     function(err, result){
          if (err){
...
module.exports.SupprimerPhotoChoix = function(request, response){
    response.title = "Vips";
